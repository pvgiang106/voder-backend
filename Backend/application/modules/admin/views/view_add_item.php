 <div class="col-md-12" id="content">
    ...
    <div class="col-md-12" style="padding-top: 20px;">
     ...
     <form role="form" method="post" action="<?php echo base_url().'admin/verifypartner/insertitem'?>" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-top: 20px;">
            ...
            <a style="color: #333;" href="<?php echo base_url().'admin?tab_active=0'; ?>"><button class="btn btn-default" type="button" name="reset">Cancel</button></a>
        </div>
