 <div class="col-md-12" id="content">
    ...
    <div class="col-md-5" style="padding-top: 20px;">
     ...
     <form role="form" method="post" action="<?php echo base_url().'admin/changepass'?>">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-top: 20px;">
            ...
            <a style="color: #333;" href="<?php echo base_url().'admin'; ?>"><button type="button" class="btn btn-default" name="reset">Cancel</button></a>
        </div>
