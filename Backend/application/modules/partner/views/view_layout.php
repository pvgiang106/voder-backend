    ...
    <body>
       	<div class="container-fluid">            
            <div class="row" id="header">
                <div class="col-md-12">
                    <div class="row">
                    <div class="col-md-6"><a href="<?php echo base_url().'partner'; ?>"><img src="<?php echo base_url(); ?>assets/img_logo.png" /></a></div>
                    <div class="col-md-6" id="setting">
                        <button type="button" class="btn" data-toggle="dropdown" aria-expanded="false"><?php echo $user['email'] ?><img src="<?php echo base_url(); ?>assets/icon_setting.png" /></button>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="<?php echo base_url().'partner/editpartner'?>">Edit Details</a></li>
                                <li><a href="<?php echo base_url().'partner/partnertransaction'?>">Transaction</a></li>
                                <li><a href="<?php echo base_url().'partner'?>">Menu</a></li>
                                <li><a href="<?php echo base_url().'partner/changepass'?>">New Password</a></li>
                ...
                <div class="row">
                    ...
                    <li role="presentation" class="active" ><a href="#business_partner"role="tab" data-toggle="tab">Business Partners</a></li>
                    </ul>                
                </div>
                </div>                
            </div>
            <div class="row" id="content">
                 <!-- Tab panes -->
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="business_partner">
                        <?php
