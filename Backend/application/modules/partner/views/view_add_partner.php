 <div class="col-md-12" id="content">
    ...
    <div class="col-md-5 col-md-offset-2" style="padding-top: 20px;">
     ...
     <form role="form" method="post" action="<?php echo base_url().'partner/verifypartner/insert'?>">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-top: 20px;">
            ...
            <a style="color: #333;" href="<?php echo base_url().'partner?tab_active=0'; ?>"><button  type="button" class="btn btn-default" >Cancel</button></a>
        </div>
