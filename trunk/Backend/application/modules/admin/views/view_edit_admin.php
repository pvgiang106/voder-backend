...
?>
    <div class="col-md-12" id="content">
        ...
        <div class="col-md-5" style="padding-top: 20px;">
            <p style="color: #4dd6ce; margin:0px;"><b>Edit Admin</b></p>
            <p>Admin Details</p>
        </div>
     
        </div> 
        <form role="form" method="post" action="<?php echo base_url().'admin/verifypartner/updatepartner/'.$partnerInfo->partnerID ?>" enctype="multipart/form-data">
